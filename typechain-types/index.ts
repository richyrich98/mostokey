...
export type { RightsFactory } from "./contracts/RightsFactory";
export { RightsFactory__factory } from "./factories/contracts/RightsFactory__factory";
export type { VideoRightsToken } from "./contracts/VideoRightsToken";
export { VideoRightsToken__factory } from "./factories/contracts/VideoRightsToken__factory";
